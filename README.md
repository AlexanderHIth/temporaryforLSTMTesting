...
- Cleaner table task data can be downloaded from: `https://studentuml-my.sharepoint.com/:f:/r/personal/andrea_pierre_student_uml_edu/Documents/table-task?csf=1&web=1&e=nAn7l5` (need to be granted access).
